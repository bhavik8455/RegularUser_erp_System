...
<body style="background-image: url(images/file.jpg);">
	<main>
		<div class="container"
			...
			<img src="images/tj.jpg" class="rounded-circle" alt="" height="50"
				width="50" />
			<div class="mt-2"
			...
			<form action="Register" method="post" id="registrationForm">
				<div class="form-floating mb-3 mt-3">
					<input type="mail" class="form-control" name="mail" id="formId1"
						placeholder="Enter your Mail Id" /> <label for="formId1">Mail
						ID</label>
				</div>
				<div class="form-floating mb-3">
					<input type="text" class="form-control" name="name" id="formId2"
						placeholder="Enter your name" /> <label for="formId2">Name</label>
				</div>
				<div class="form-floating mb-3 mt-4">
					<input type="password" class="form-control" name="pword"
						id="password" placeholder="Enter your password" /> <label
						for="password">Password</label>
					<div class="error-message" id="passwordError"></div>
				</div>
				<div class="form-floating mb-3 mt-4">
					<input type="password" class="form-control" name="confirmPassword"
						id="confirmPassword" placeholder="Confirm your password" /> <label
				...
				<div class="mt-3"
					...
					<span style="color: white">Already have an Account? <a
						href="login.jsp" style="color: rgb(0, 0, 0)">Sign in</a></span>
				</div>
			</form>
		</div>
	</main>
